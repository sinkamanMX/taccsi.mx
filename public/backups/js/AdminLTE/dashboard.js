...
function getInfo(idEstatus){
    location.href='/admin/admin/getinfo?estatus='+idEstatus;
}

function infoViaje(idvalue){
    $.ajax({
        url: "/main/admin/getmore",
        type: "GET",
        data: { idviaje: idvalue},
        success: function(data) {
            var result = data; 
            $("#containerrow").html(result);
            initialize();                         
        }
    });    
}
    ...
    function drawMarkers(){
        var pOrigen = $("#pos_origen").val().split("|");
        var pDestino= $("#pos_destino").val().split("|");

        var latLonOrigen = new google.maps.LatLng(pOrigen[0],pOrigen[1]);
        var latLonDest   = new google.maps.LatLng(pDestino[0],pDestino[1]);
        ...
        directions.start = latLonOrigen;
        directions.end = latLonDest;
